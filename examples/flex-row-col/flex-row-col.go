...
func New() Bubble {
	...
	verticalLayout := flex.NewContainer(flex.Column).
		AddBox(boxOne, flex.NewBoxStyle(1)).
		AddBox(boxTwo, flex.NewBoxStyle(1))
	layout := flex.NewContainer(flex.Row).
		AddBox(verticalLayout, flex.NewBoxStyle(1)).
		AddBox(boxThree, flex.NewBoxStyle(4))
